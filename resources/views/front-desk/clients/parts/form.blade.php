...
<div class="mb-3">
    ...
    <input name="name" class="form-control @error('name') is-invalid @enderror" id="name" aria-describedby="name"
    ...
    @foreach($roles as $role)
        <div class="form-check">
            <input class="form-check-input" name="roles[]"
                ...
                @isset($user) @if(in_array($role->id, $user->pluck('id')->toArray())) checked @endif @endisset>
